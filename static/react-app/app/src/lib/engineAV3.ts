...
export function resolveEngineAV3Signal(signal: EngineASignal): EngineASignal {
  ...
  return {
    ...
    intermarketEngineADelta: pickField(raw, 'intermarketEngineADelta', 'engine_a_intermarketEngineADelta'),
    intermarketConfirmation: pickField(raw, 'intermarketConfirmation', 'engine_a_intermarketConfirmation'),
    pre_news_score: pickField(raw, 'pre_news_score', 'engine_a_pre_news_score'),
    news_adjustment: pickField(raw, 'news_adjustment', 'engine_a_news_adjustment'),
