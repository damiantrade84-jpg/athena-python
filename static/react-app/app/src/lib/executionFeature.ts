  ...
  await postQuickExecute(
    {
      signal: {
        ...
        tier: found.tier,
        signalTier: found.signalTier as string | undefined,
        decision_state: found.decision_state as string | undefined,
        decision_state_reason: found.decision_state_reason as string | undefined,
        components: found.components as Record<string, unknown> | undefined,
        engine_b_status: found.engine_b_status as Record<string, unknown> | undefined,
        rr: found.rr as number | undefined,
      },
      engine_b: engineB,
      pip_mode: pipMode || 'swing',
