...
function openChartIntentPayload(candidate: EngineBHotlistCandidate, row: LdSymbolRow | null, timeframe: string) {
  ...
  return {
    ...
    signal: {
      ...
      structureTf: row?.engineB.sourceTimeframes?.zone_tf || null,
      triggerTf: row?.engineB.sourceTimeframes?.trigger_tf || null,
      executionTf: row?.engineB.sourceTimeframes?.entry_tf || null,
