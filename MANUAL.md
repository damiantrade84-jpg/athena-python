# Sentinel Pro v4.0 — Operational Manual
...
```
[INFO] Sentinel Pro v4.0 - Python Edition
...
| Indices | UK100, S&P 500 (US500), Dow Jones (US30) | Full support |
...
- **After waking:** Refresh the browser (F5). If Sentinel Process died, run `start_sentinel.bat` again
