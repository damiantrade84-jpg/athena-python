...
def get_engine_b_playbook() -> dict:
    return {
        ...
        "structureUsage": {
            ...
            "engineBContext.tp1PathClear / tp1PathBlockReason": "Deterministic TP1 reachability before the nearest opposing zone. False tp1PathClear blocks spaceGateOk for scale-out and capped-structural substitution.",
            "engineBContext.structuralSl / executionSl / executionSlInsideStructuralInvalidation": "Structural invalidation level vs ATR/mechanical execution stop. Tighter execution SL increases stop-out risk but is not automatically invalid unless a deterministic gate says so.",
        ...
        "mustRejectIf": [
            ...
            "Reject or wait when TP1 itself is beyond the nearest opposing zone or entry is inside the opposing zone with no clean partial target.",
