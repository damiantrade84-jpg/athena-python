...
def get_engine_a_playbook() -> dict:
    return {
        ...
        "indicatorUsage": {
            ...
            "factorScores.location / factorDiagnostics.components.location": "V3 location/value component; poor location with high confluence still warrants WAIT.",
            "factorScores.volume / factorDiagnostics.components.volume": "V3 volume/flow component. When volumeType is tick (forex) or mixed (commodity) do NOT penalize on volume. Legacy alias: diagnostics.volumeScore.",
