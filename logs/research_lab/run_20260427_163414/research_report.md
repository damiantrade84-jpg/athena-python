...
**Run ID:** `run_20260427_163414`  **Generated:** 2026-04-27 16:34 UTC  
**Mode:** tiny  **Symbols:** 6  **Families:** ['engine_b_proxy']
...
Best `engine_b_proxy` config: `structure_filters` params=`fvg_detection=False|strong_close_pct=0.8`
  ...
  - Win rate: 37.6%  PF: 1.08  Robustness: 0.53  Status: `WEAK_CANDIDATE`
...
- `engine_b_proxy`: 23 configs rejected — insufficient edge at current parameters
