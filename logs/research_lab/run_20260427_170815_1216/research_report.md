...
**Run ID:** `run_20260427_170815_1216`  **Generated:** 2026-04-27 17:08 UTC  
**Mode:** small  **Symbols:** 1  **Families:** ['engine_d_proxy']
...
--- | --- | --- | --- | --- | ---
engine_d_proxy | 2 | 0.3527 | 0.4423 | 1.6588 | 1.3362

**Best family:** `engine_d_proxy` (avg net return 0.353)
...
Best `engine_d_proxy` config: `micro_breakout` params=`atr_sl_mult=0.5|fee_guard_r=0.5|range_bars=6`
  ...
  - Win rate: 44.2%  PF: 1.66  Robustness: 0.70  Status: `WEAK_CANDIDATE`
...
- `engine_d_proxy`: 2 configs rejected — insufficient edge at current parameters
