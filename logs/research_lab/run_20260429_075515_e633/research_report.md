...
**Run ID:** `run_20260429_075515_e633`  **Generated:** 2026-04-29 07:55 UTC  
...
**Best family:** `breakout` (avg net return 0.014)

## Which Symbol Works Best?
symbol | count | avg_net_return | avg_wr
--- | --- | --- | ---
NAS100 | 2 | 0.0138 | 0.3964
...
- `breakout`: 2 configs rejected — insufficient edge at current parameters

## Recommended Next Tiny Test
Run `session_opening_range` on `NAS100` `H1`.
