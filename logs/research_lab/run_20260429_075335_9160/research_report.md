...
**Run ID:** `run_20260429_075335_9160`  **Generated:** 2026-04-29 07:53 UTC  
...
--- | --- | --- | --- | --- | ---
engine_b_proxy | 2 | 0.4535 | 0.5068 | 1.8285 | 1.3045

**Best family:** `engine_b_proxy` (avg net return 0.453)

## Which Symbol Works Best?
symbol | count | avg_net_return | avg_wr
--- | --- | --- | ---
XAG/USD | 2 | 0.4535 | 0.5068
...
--- | --- | ---
structure_filters | 0.5000 | -0.0388
...
Best `engine_b_proxy` config: `structure_filters` params=`fvg_detection=True|strong_close_pct=0.7`
  ...
  - Win rate: 51.4%  PF: 1.94  Robustness: 0.72  Status: `WEAK_CANDIDATE`
