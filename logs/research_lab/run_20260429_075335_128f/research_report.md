...
**Run ID:** `run_20260429_075335_128f`  **Generated:** 2026-04-29 07:53 UTC  
...
--- | --- | --- | --- | --- | ---
pullback | 4 | 0.5730 | 0.2224 | 2.3706 | 1.3059

**Best family:** `pullback` (avg net return 0.573)

## Which Symbol Works Best?
symbol | count | avg_net_return | avg_wr
--- | --- | --- | ---
XAG/USD | 4 | 0.5730 | 0.2224
...
Best `pullback` config: `pullback_ema` params=`pullback_period=20|rsi_reclaim=False|rsi_threshold=50|trend_period=200`
  ...
  - Win rate: 31.5%  PF: 1.91  Robustness: 0.70  Status: `WEAK_CANDIDATE`
