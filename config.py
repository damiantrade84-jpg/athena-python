...
CONFIG: dict = {
    ...
    "MARCUS_AI_PROVIDER": os.environ.get("MARCUS_AI_PROVIDER", "grok"),
    "MARCUS_AI_TIMEOUT_SEC": 150.0,
    ...
    "AI_SCALP_CHART_REVIEW": {
        ...
        "PAPER_DEMO_EXECUTE_REQUIRES_AI_REVIEW": _env_bool(
            "AI_SCALP_CHART_REVIEW_PAPER_DEMO_EXECUTE_REQUIRES_AI_REVIEW", False
        ),
    ...
    # Longer adaptive-trail max-hold/stagnation horizon in management bars.
    # A scalar remains accepted for backward compatibility; 0 disables it.
    "ENGINE_B_TIME_EXIT_BARS": {"scalp": 12, "intraday": 18, "swing": 10},
    # Explicit time_based mode uses elapsed wall-clock minutes. It is separate
    # from the longer adaptive-trail stagnation horizon above.
    "ENGINE_B_TIME_EXIT_MINUTES": {"scalp": 30, "intraday": 60, "swing": 14400},
    ...
    "ENGINE_A_V3_DIRECTIONAL_RAMP_BY_CLASS": {
        "crypto_btc": {"min_directional": 0.04, "soft_span": 0.06},
        "crypto_eth": {"min_directional": 0.04, "soft_span": 0.06},
        "crypto_alt_majors": {"min_directional": 0.04, "soft_span": 0.06},
        "crypto_doge": {"min_directional": 0.045, "soft_span": 0.055},
        "crypto_other": {"min_directional": 0.05, "soft_span": 0.05},
        "forex_majors": {"min_directional": 0.05, "soft_span": 0.07},
        "forex_crosses": {"min_directional": 0.05, "soft_span": 0.07},
        "forex_other": {"min_directional": 0.05, "soft_span": 0.07},
        "forex_exotics": {"min_directional": 0.045, "soft_span": 0.065},
        "us_stock_single": {"min_directional": 0.06, "soft_span": 0.08},
        "stock_other": {"min_directional": 0.06, "soft_span": 0.08},
        "us_indices_trackers": {"min_directional": 0.05, "soft_span": 0.07},
        "eu_indices": {"min_directional": 0.05, "soft_span": 0.07},
        "asian_indices": {"min_directional": 0.05, "soft_span": 0.07},
        "index_other": {"min_directional": 0.05, "soft_span": 0.07},
        "precious_trackers": {"min_directional": 0.05, "soft_span": 0.08},
        "energy_oil": {"min_directional": 0.05, "soft_span": 0.08},
        "nat_gas": {"min_directional": 0.05, "soft_span": 0.08},
        "copper": {"min_directional": 0.05, "soft_span": 0.08},
        "pgm_metals": {"min_directional": 0.05, "soft_span": 0.08},
        "base_metals": {"min_directional": 0.05, "soft_span": 0.08},
    ...
    "CARRY_STATIC_RATES_AS_OF": "2026-08-28",
    "CARRY_STATIC_RATES_MAX_AGE_DAYS": 30,
    "CARRY_FRED_MAX_OBSERVATION_AGE_DAYS": {"daily": 7, "monthly": 120},
    ...
    # the flat 5s limit rejects them almost always. Index CFDs do the same
    # outside cash hours (AUS200.s 47.28s on 2026-08-19). Classes absent here
    # keep MAX_BROKER_TICK_AGE_SEC.mt5.
    "MAX_BROKER_TICK_AGE_SEC_BY_ASSET_TYPE": {"stock": 90, "index": 60},
    ...
    "ENGINE_B_IMBALANCE": {
        ...
        "BAG_MIN_DISPLACEMENT_BODY_ATR": 0.80,
        "BAG_MIN_BODY_RANGE_RATIO": 0.65,
        "BAG_BREAKOUT_LOOKBACK_BARS": 8,
        "BAG_MIN_FOLLOWTHROUGH_BARS": 2,
...
_KNOWN_YAML_ONLY_KEYS = {
    ...
    "CARRY_FRED_MAX_OBSERVATION_AGE_DAYS",
