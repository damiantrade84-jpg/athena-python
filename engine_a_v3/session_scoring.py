...
def session_context_score(
    ...
    *,
    ...
    direction_aligned = (direction == "LONG" and net > 0) or (direction == "SHORT" and net < 0)
...
def session_score_passes(primary: list[dict], *, direction: str | None, min_score: float) -> bool:
    score, _ = session_context_score(primary, direction=direction)
